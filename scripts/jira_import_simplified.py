#!/usr/bin/env python3
"""
Simplified Jira Import Script for JobPulse
Works with available issue types: Epic, Task, Sub-task
"""
...
class SimplifiedJiraImporter:
    """Simplified Jira ticket importer using REST API v3"""
    ...
    def create_epic(self, epic_data: Dict[str, Any], project_key: str) -> str:
        """Create an epic"""
        try:
            logger.info(f"Creating epic: {epic_data}")
...
def main():
    ...
    # Create importer
    importer = SimplifiedJiraImporter(jira_site, api_token, "ammrabbasher@gmail.com")
