#!/usr/bin/env python3
"""
Assign Categories to Jira Tickets - Fixed Version
Uses proper label formats without spaces
"""
...
class CategoryAssignmentFixed:
    """Assign categories to Jira tickets using proper label formats"""
    ...
    def __init__(self, jira_site: str, api_token: str, email: str = None):
        ...
        # Category mapping with proper label formats
        self.category_mapping = {
            "data-upgrades": {
                "display_name": "🚀 Data Upgrades",
            ...
            "technical-upgrades": {
                "display_name": "🔧 Technical Upgrades", 
            ...
            "monetization-tasks": {
                "display_name": "💰 Monetization Tasks",
    ...
    def analyze_issue_for_category(self, issue_data: Dict[str, Any]) -> str:
        ...
        try:
            ...
            category_scores = {}
            for category_key, config in self.category_mapping.items():
                score = 0
            ...
            display_name = self.category_mapping[best_category]["display_name"]
            logger.info(f"📊 {issue_data.get('key', 'Unknown')}: {display_name} (score: {category_scores[best_category]})")
    ...
    def update_issue_labels(self, issue_key: str, category: str) -> bool:
        ...
        try:
            ...
            # Add category-specific labels (without spaces)
            ...
            if response.status_code == 204:
                display_name = self.category_mapping[category]["display_name"]
                logger.info(f"✅ Updated {issue_key} with category: {display_name}")
                return True
            else:
    ...
    def assign_categories_to_all_tickets(self) -> bool:
        ...
        try:
            ...
            for category, count in category_counts.items():
                display_name = self.category_mapping[category]["display_name"]
                logger.info(f"  {display_name}: {count} tickets")
...
def main():
    ...
    assigner = CategoryAssignmentFixed(jira_site, api_token, "ammrabbasher@gmail.com")
